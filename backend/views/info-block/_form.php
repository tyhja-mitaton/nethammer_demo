...
$(document).find('[name="InfoBlock[type]"]').on('change', function() {
  ...
  switch (parseInt($(this).val(), 10)) {
    case $sliderType: avatarBlock.removeClass('d-none');imgsBlock.addClass('d-none');btnLbl.text('Ссылка');seoBlock.addClass('d-none');introBlock.addClass('d-none');extraDescrBlock.addClass('d-none');break;
